...
class Autonomous:
    ...
    def executeAuton(self):
        ...
        if self.autonTask[0] == "MOVE":
            ...
            self.modules['front_left'].move(self.moduleStates[0].speed / self.maxSpeed, (self.moduleStates[0].angle.degrees() + 90) % 360)
            self.modules['front_right'].move(self.moduleStates[1].speed / self.maxSpeed, (self.moduleStates[1].angle.degrees() + 90) % 360)
            self.modules['rear_left'].move(self.moduleStates[2].speed / self.maxSpeed, (self.moduleStates[2].angle.degrees() + 90) % 360)
            self.modules['rear_right'].move(self.moduleStates[3].speed / self.maxSpeed, (self.moduleStates[3].angle.degrees() + 90) % 360)
