...
class MyRobot(wpilib.TimedRobot):
    def robotInit(self):
        ...
        wpilib.SmartDashboard.putNumber("PDP",self.pdp)
    ...
    def robotPeriodic(self):
        coralCurrent = self.pdp.getCurrent(11)
        wpilib.SmartDashboard.putNumber("Coral Current (11)", coralCurrent)
        
        PDMCurrent = self.pdp.getCurrent(20)
        wpilib.SmartDashboard.putNumber("PDM Current (20)", PDMCurrent)
