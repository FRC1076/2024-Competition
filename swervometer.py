...
class Swervometer:
    ...
    def updateTeamColorGyroAdjustment(self, team_gyro_adjustment, team_move_adjustment):
        self.teamGyroAdjustment = team_gyro_adjustment
        self.teamMoveAdjustment = team_move_adjustment

    def updateFieldStartPositionCoordinates(self, start_position_x, start_position_y, start_angle):
