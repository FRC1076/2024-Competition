...
autonConfig = {
    ...
    'TASK_RED_A': [['WAIT', 2], ['UPDATE_POSE'], ['MOVE', 230.5, 57, 0], ['WAIT', 2], ['MOVE', 294, 57, 0], ['WAIT', 2], ['UPDATE_POSE'], ['MOVE', 262.25, 114, 0], ['WAIT', 2], ['MOVE', 294, 114, 0], ['WAIT', 2], ['MOVE', 294, 57, 0], ['WAIT', 2], ['MOVE', 262.25, 0, 0], ['MOVE', 230.5, 0, 0], ['WAIT', 2], ['MOVE', 294, 57, 0]]
}
