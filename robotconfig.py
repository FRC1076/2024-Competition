...
autonConfig = {
    ...
    'A_THREE_NOTE_NO_CENTER': [['START_INTAKE'],
                               ['RAISE_ARM_START', -15],
                               ['PATH', 'A-ABACK'],
                               ['ROTATE', 50],
                               ['SHOOT_NOTE'],
    ...
    'B_FOUR_NOTE_GRAB': [['START_INTAKE'],
                         ['RAISE_ARM_START', -25.9],
                         ['WAIT', 1],
                         ['SHOOT_NOTE'],
                         ['LOWER_ARM_START', -37],
                         ['PATH_TO_NOTE', 'B-1', 0.5],
                         ['RAISE_ARM_START', -10],
                         ['PATH', '1-SHOT'],
                         ['SHOOT_NOTE'],
                         ['LOWER_ARM_START', -37],
                         ['PATH_TO_NOTE', 'SHOT-2', 0.3],
                         ['RAISE_ARM_START', 0],
                         ['WAIT', 0.5],
                         ['SHOOT_NOTE'],
                         ['LOWER_ARM_START', -37],
                         ['PATH_TO_NOTE', '2-3', 0.3],
                         ['RAISE_ARM_START', -5],
                         ['PATH', '3-2'],
                         ['SHOOT_NOTE'],
                         ['LOWER_ARM_START', -37]],

    'B_THREE_NOTE_AMP_SIDE': [['START_INTAKE'],
                              ['WAIT', 0.5],
                              ['RAISE_ARM_START', -25.9],
                              ['SHOOT_NOTE'],
                              ['LOWER_ARM_START', -37],
    ...
    'B_THREE_NOTE_STAGE_SIDE': [['START_INTAKE'],
                                ['WAIT', 0.5],
                                ['RAISE_ARM_START', -25.9],
                                ['SHOOT_NOTE'],
                                ['LOWER_ARM_START', -37],
    ...
    'C_TWO_NOTE_CENTER_LINE':[['START_INTAKE'],
                              ['RAISE_ARM_START', -7],
                              ['PATH', 'C-COUT'],
                              ['ROTATE', -75],
                              ['SHOOT_NOTE'],
    ...
    'C_TWO_NOTE_CENTER_LINE_NOTE_GRAB':[['START_INTAKE'],
                                        ['RAISE_ARM_START', -7],
                                        ['PATH', 'C-COUT'],
                                        ['ROTATE', -75],
                                        ['SHOOT_NOTE'],
                                        ['LOWER_ARM_START', -37],
                                        ['ROTATE', 0],
                                        ['PATH_TO_NOTE', 'COUT-8', 1.5],
                                        ['RAISE_ARM_START', -7],
                                        ['PATH', '8-COUT'],
                                        ['ROTATE', -75],
                                        ['SHOOT_NOTE'],
                                        ['LOWER_ARM_START', -37]],
    'NOTE_GRAB_TEST': [['START_INTAKE'],
                       ['MOVE_TO_NOTE', -(275 - 64), 57, 180, 0],
                       ['RAISE_ARM_START', 0]],
    'TEST': [['PATH', 'TEST']],
