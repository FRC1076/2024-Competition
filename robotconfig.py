...
autonConfig = {
   ...
   'E_CENTER_THREE_NOTE': [['START_INTAKE'],
    ...
    'TEST_NOTE': [['START_INTAKE'], ['PATH', 'TEST', 0]],
...
mechanismConfig = {
    ...
    #trap stuff - NEEDS TO BE UPDATED
    'TRAPCLIMB_LEFT_MOTOR_ID': 59,
    'TRAPCLIMB_RIGHT_MOTOR_ID': 58,
    'TRAPCLIMB_LEFT_MOTOR_SPEED': -0.2,
    'TRAPCLIMB_RIGHT_MOTOR_SPEED': 0.2,
    'TRAPCLIMB_LEFT_MOTOR_STOP_SPEED': 0.1,
    'TRAPCLIMB_RIGHT_MOTOR_STOP_SPEED': -0.1,
    # 'TRAPCLIMB_FEEDFORWARD_KS': 0,
    # 'TRAPCLIMB_FEEDFORWARD_KV': 0,
    # 'TRAPCLIMB_FEEDFORWARD_KA': 0,
}
...
noteDetectorConfig = {
    ...
    "NOTE_HEIGHT": 2.0,
    "NOTE_DIAMETER": 14.0,
    "CAMERA_ANGLE_ABOVE_HORIZONTAL": -27.5, #-37.5
    "CAMERA_OFFSET_X": 0,
    "CAMERA_OFFSET_Y": 12,
    "CAMERA_FOV_Z": 41.232,
    "CAMERA_FOV_X": 62.548,
