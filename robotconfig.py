...
autonConfig = {
    ...
    '1-SHOT': -10, #B shot first note 
    '1-1SHOT': 0, #D second note
    'SHOT-2': 0, #B shot after getting note 2
    ...
    'B_FAST_FOUR_NOTE_SUBWOOFER': [['START_INTAKE'],
                                  ...
                                  ['PATH', 'B-1[FAST]'],
                                  ['RAISE_ARM_START', '1-SHOT'],
                                  ['PATH', '1-SHOT[FAST]'],
                                  ['SHOOT_NOTE'],
                                  ['LOWER_ARM_START', 'INTAKE'],
                                  ['PATH', 'SHOT-2'],
                                  ['RAISE_ARM_START', 'SHOT-2'],
                                  ['WAIT', 0.5],
                                  ['SHOOT_NOTE'],
                                  ['LOWER_ARM_START', 'INTAKE'],
                                  ['PATH', '2-3[FAST]'],
